...
const int mqttPort = 15699;
const char *mqttUser = "hbyyalui";
const char *mqttPassword = "B_9gCH7bI6ZD";
...
void setClientData()
{
    ...
    // Serial.println("Setting the callback");
...
void publishTo(String topic, String message)
{
    ...
    topicChar[i] = '\0';
    messageChar[j] = '\0';
    Serial.print("Size of TopicChar: ");
    Serial.println(sizeof(topicChar));
    Serial.print("Trying to pulish to: ");
